...
// "FALSE:"
export{}
let my_name:String = "Reebaal";
let behaviour:String = "He is a good boy";
console.log("Is Reebaal a good boy?")
console.log(my_name == behaviour);
// "TRUE:"
let my_city:String = "My city is very beautiful...";
let my_country:String = "My city is very beautiful..."
...
// • Tests using the lower case function
// "FALSE:"
let name1:String = "Reebaal";
let name2:String = "rEEbaAL";
console.log("Are both my names?")
console.log(name1.toLowerCase() == name2);
// "TRUE:"
let name3:String = "Reebaal";
let name4:String = "rEEbaAL";
console.log("Are both my names?")
...
// • Numerical tests involving equality and inequality, greater than and less than, greater than or equal to, and less than or equal to
// "TRUE:"
let num1:number = 12*12;
let num2:number = 200/2+84-40;
...
let country2:String = "Turkey";
let country3:String = "China";
let country4:String = "Korea";
console.log("Do all countries have same culture?")
console.log(country1 && country2 == country3 && country4);
// "True:"
let country5:String = "China";
let country6:String = "Turkey";
let country7:String = "China";
let country8:String = "Turkey";
