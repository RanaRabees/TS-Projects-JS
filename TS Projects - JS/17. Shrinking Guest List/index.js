...
console.log("Alas!!!!!! ".concat(guests[0], ", ").concat(guests[1], ", ").concat(guests[2], ", ").concat(guests[3], ", ").concat(guests[4], ", and ").concat(guests[5], " I am very sorry to say that there's a problem with the table space so all of you can't be managed...\n"));
console.log(guests);
for (var i = 0; i < 4; i++) {
    console.log("".concat(guests.splice(0, 1), " I am very sorry about this next time maybe..."));
}
console.log("Dear ".concat(guests[0], ", somehow I managed to create space you are still invited Please join us..."));
console.log("Dear ".concat(guests[1], ", somehow I managed to create space you are still invited Please join us..."));
guests.pop();
guests.pop();
console.log(guests);
